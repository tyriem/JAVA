...
public class DiceGameThreeEvens {
    ...
    public static void main(String[] args) {
        ...
        //Modulo the second roll by 2 and evaluate it against zero to check if the roll is even or odd then interate the counter if it is. Then Print if the roll is even or odd.
        ...
        //Modulo the fourth roll by 2 and evaluate it against zero to check if the roll is even or odd then interate the counter if it is. Then Print if the roll is even or odd.
